      ...
      <div className="container-custom flex flex-col gap-3 py-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="shrink-0">
          <button
            ...
            className="rounded-md bg-white px-6 py-3 text-sm font-bold text-[hsl(240_60%_25%)] transition-colors hover:bg-white/90 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-primary"
          >
            Aceitar
          </button>
        </div>
