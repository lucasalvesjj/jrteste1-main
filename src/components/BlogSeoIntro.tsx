...
import { BLOG_SEO_TEXT_HTML } from "@/data/blogSeoText";
    ...
    <div className="mx-auto mb-4 max-w-3xl pt-4 text-center">
      {expanded && (
        <Button
          ...
          size="sm"
          aria-expanded={true}
          aria-controls="blog-seo-content"
      ...
      <div className="relative">
        <div
          ...
          dangerouslySetInnerHTML={{ __html: BLOG_SEO_TEXT_HTML }}
        />
